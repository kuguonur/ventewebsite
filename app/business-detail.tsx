...
const content = {
  ...
  chemicals: {
    ...
    tr: {
      ...
      services: ["POE kompresör yağları", "PAG kompresör yağları", "Sistem temizleme kimyasalları", "Serpantin temizleyiciler", "Kaçak tespit ürünleri", "Servis ve bakım çözümleri"],
    ...
    en: {
      ...
      services: ["POE compressor oils", "PAG compressor oils", "System cleaning chemicals", "Coil cleaners", "Leak detection products", "Service and maintenance solutions"],
    ...
    fr: {
      ...
      services: ["Huiles POE pour compresseurs", "Huiles PAG pour compresseurs", "Produits chimiques de nettoyage des systèmes", "Nettoyants pour serpentins", "Produits de détection des fuites", "Solutions de service et de maintenance"],
